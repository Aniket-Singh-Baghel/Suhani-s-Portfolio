  ...
  return (
    <div>
      <nav className="relative z-30 flex justify-between items-center py-6">
        <h2
          onClick={() => navigate("/")}
          className="font-serif tracking-[0.15em] text-base cursor-pointer z-50 relative"
        >
          SUHANI SINGH
        </h2>
        ...
        >
          <span
            className={`block w-6 h-[2px] bg-black transition-transform duration-300 ${isSidebarOpen ? "rotate-45 translate-y-[8px]" : ""}`}
          ></span>
          <span
            className={`block w-6 h-[2px] bg-black transition-opacity duration-300 ${isSidebarOpen ? "opacity-0" : ""}`}
          ></span>
          <span
            className={`block w-6 h-[2px] bg-black transition-transform duration-300 ${isSidebarOpen ? "-rotate-45 -translate-y-[8px]" : ""}`}
          ></span>
